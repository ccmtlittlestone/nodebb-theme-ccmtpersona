...
$(document).ready(function() {
	...
	function setupNProgress() {
		...
		$(window).on('action:ajaxify.end', function(ev, data) {
			...
			} else if (data.url && data.url.match('#_=_')) { //for facebook login
				app.alertSuccess('<iframe name="fd37dcb4b0afac" width="265px" height="70px" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" title="fb:page Facebook Social Plugin" src="https://www.facebook.com/v2.3/plugins/page.php?adapt_container_width=true&app_id=113869198637480&channel=https%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter%2Fr%2F87XNE1PC38r.js%3Fversion%3D42%23cb%3Df15287f6e5f2df4%26domain%3Ddevelopers.facebook.com%26origin%3Dhttps%253A%252F%252Fdevelopers.facebook.com%252Ff3db9ff5613c518%26relation%3Dparent.parent&container_width=613&height=70&amp;hide_cover=true&href=https%3A%2F%2Fwww.facebook.com%2FSuperSUofficial&locale=en_US&;sdk=joey&amp;show_facepile=false&amp;small_header=true&tabs=timeline&width=265" style="border: none; visibility: visible; width: 265px; height: 70px;" class=""></iframe>', 8000);
			}
		});
	}
